...
const InputLogin = () => {
    const image = "../public/float (1).png"

  return (
    <div className='flex mt-20 justify-center gap-12 ml-[-8rem]'>
    <img src={image} alt="photo" className='w-[40%] my-auto h-full' />
    <div>
    <div className="relative flex w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
  <div className="relative mx-4 -mt-6 mb-4 grid h-28 place-items-center overflow-hidden rounded-xl bg-gradient-to-tr bg-[#0071FF] bg-clip-border text-white shadow-lg shadow-blue-500/40">
  ...
  <div className="p-6 pt-0">
    ...
    <div className="relative flex mt-6 w-96 flex-col rounded-xl bg-white bg-clip-border text-gray-700 shadow-md">
      
    <p className="mt-6 mb-6 flex justify-center font-sans text-sm font-light leading-normal text-inherit antialiased">
      Belum punya akun?
      <a
        href="/"
